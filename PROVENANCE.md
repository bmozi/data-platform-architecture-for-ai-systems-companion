...
- **Created:** 2026-08-29
- **Book repository:** `bmozi/architecting-data-platforms-in-the-age-of-ai`
- **Source commit:** `28e7d9c`
...
- **Added:** plain-language AI-ready data journey and readiness ladder,
  role-based routes, team workshop, value-and-evidence ledger, executive
  decision brief, failure lab, and pilot/usability route
...
- **Validation boundary:** repository validation can confirm structure and
  links, not reader comprehension, data fitness, or AI effectiveness
...
- **Authority:** Portfolio API/Data pilot program and reader-value completion
  standard
- **Added:** `DATA-RV-PILOT-001` version 1.0.0, a two-stage practitioner/domain
  and decision-owner packet for the plain-language AI-ready data journey
- **Scenario status:** Harbor Grove is constructed and fictional
...
- **Use:** Data Platforms-specific worksheet connecting present architecture to
