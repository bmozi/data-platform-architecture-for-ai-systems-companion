...
**September 5 aligned book source (historical):** `e6418c390d1e345448470f4b403c0162470c4872` (September 5, 2026).
...
- portable links that replace a book-relative path with its exact repository
  URL;
- standalone-only reader-value, facilitator, decision-owner, journey, and
...
`README.md`, the standalone AI-ready data journey route, the portable research
link in `examples/README.md`, and the newer reader-value route in
`testing/README.md`.

Semantic ownership, quality, lineage, purpose, access, freshness, fitness,
evidence states, example facts, and scoring criteria may not diverge silently.
Change those in both maintained copies or create a named new version with a
provenance entry and migration decision.
...
prove usability, AI readiness, data quality, business value, or publication
readiness.
