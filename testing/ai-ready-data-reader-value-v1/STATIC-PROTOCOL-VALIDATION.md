...
8. the next sealed phase-input or closing evidence manifest hashes the governed
...
immutable correction identity. Ten negative mutations prove the validator
...
output field. Structured mutations refresh surrounding checksums so rejection
depends on the invariant rather than merely a stale hash.
